...
Две роли - тот кто публикует и гость.

2.1.1 Авторизованный
...
После регистрации появляется возможность публиковать объявления, просматривать контакты, указанные в чужих объявлениях и писать в чат.
...
- Авторизованные пользователи – полный доступ ко всем функциям, включая контакты владельцев объявлений и личный кабинет.
- Гости – могут просматривать объявления, но без доступа к контактам и личному кабинету.

### 2.2.1 Классический каталог объявлений

Страница с категориями/подкатегориями и карточками объявлений

### 2.2.2 Интерактивная карта

Карта позволяет оценить расстояние до объявления, что помогает избежать лишних затрат. (Например: не выгодно ехать за бесплатной мебелью в другой город)
